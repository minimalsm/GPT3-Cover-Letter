...
export default function Index() {
  return (
    <>
      <IndexNavbar fixed />
      <section className="header relative pt-10 items-center flex h-screen">

        <div className="relative z-2 flex flex-col md:flex-row content-around w-full">

          <div className="relative flex justify-center md:w-1/2 w-full">
            <div className="flex justify-center w-full md:w-8/12 lg:w-6/12 xl:w-6/12 m-4">
              <div className="pt-32 sm:pt-0">
                <h2 className="font-bold text-4xl text-gray-700">
                  Generate Great Cover Letters:
              </h2>
                <h2 className="font-bold text-4xl text-gray-700">
                  Quickly.
              </h2>
                ...
                <div className="mt-12 flex justify-center">
                  <Link href="/login">
                    <a
                      href="#"
                      className="get-started text-white font-bold px-4 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-orange-500 active:bg-gray-700 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                    >
                      I want a great cover letter <FontAwesomeIcon icon={faChevronCircleRight} />
                    </a>
                  </Link>
                </div>
              </div>
          ...
          <div className=" flex justify-center md:justify-start md:w-1/2 w-full p-3">
            <div className="bg-orange-500 md:w-full w-1/2 h-200-px rounded p-4 m-4">
              <h2>Example of app working here.</h2>
              <button className="rounded bg-white p-2 shadow
              ">Try me</button>
            </div>
          </div>
        ...
        <img
          className="absolute z--10 top-10 right-0 w-1/2 hidden md:block p-10"
          src={require("assets/img/undraw_File_synchronization_re_m5jd.svg")}
          alt="Man Opening Beautifully written cover letter"
        />
